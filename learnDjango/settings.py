...
SECRET_KEY = 'django-insecure-uj)r^vh)n0cs3bc(s&!sm8#2pu0hjdi-eem+nv$^)&pd+m57*x'
...
STATIC_URL = f'{BASE_DIR}/app3/static/'
#or use below for multiple static folders
STATICFILES_DIRS = [
    BASE_DIR / "app/static",
]
...
SESSION_COOKIE_AGE = 60 * 60 * 24 *30  # Session expiry time in seconds